...
$instruct_sql_choose = "select * from activity where activity_id ='" . $_GET['activity_id'] . "' ";
$implement_instruct = mysqli_query($condb, $instruct_sql_choose);
$m = mysqli_fetch_array($implement_instruct);
...
<body>
    ...
    <h3 style="text-align: center;">kemaskini aktiviti Baru</h3>

    <form action='updateactivityProcess.php' activity_id=<?= $m['activity_id'] ?>' method='POST'>
